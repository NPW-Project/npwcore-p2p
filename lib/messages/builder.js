...
function builder(options) {
  ...
  if (!options.network) {
    options.network = npwcore.Networks.defaultNetwork;
  }

  options.Block = options.Block || npwcore.Block;
  options.BlockHeader = options.BlockHeader || npwcore.BlockHeader;
  options.Transaction = options.Transaction || npwcore.Transaction;
  options.MerkleBlock = options.MerkleBlock || npwcore.MerkleBlock;
  options.protocolVersion = options.protocolVersion || 70912;
